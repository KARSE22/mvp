...
export default function NavBar({user}) {
  ...
  return (
    <AppBar position="static" sx={{background: 'pink'}} >
      <Container maxWidth="xl"  >
        <Toolbar disableGutters >
          <BiotechIcon sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} fontSize="large" />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <BiotechIcon sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} fontSize="large" />
          <Typography
            variant="h5"
            noWrap
            component="a"
